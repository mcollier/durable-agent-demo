...
**Created:** 2026-08-08T21:54:30.921+00:00  
**Source:** `.squad/decisions.md`

## Archive Batches

### 2026-08-08T21:54:30.921+00:00 — Archived from `decisions.md`

- Trigger size: `40318` bytes
- Archive rule: move decisions older than `30` days
- Archived entries: `14`

#### Archived Decision Blocks
...
### 2026-08-08T21:54:30.921+00:00 — Supplemental archived legacy notes

- Reason: legacy material without inline decision dates remained in `.squad/decisions.md` after the initial archive split and was older pre-session context.
